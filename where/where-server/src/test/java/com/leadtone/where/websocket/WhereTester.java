...
//			uri = new URI("ws://localhost:10009/websocket");
			uri = new URI("ws://124.251.8.70:10009/websocket");
	...
	private void testGroupOneFunction() throws Exception {
		...
		c0.sendMsg(TestMessageGenerator.genGetUserDetailMessage(mobile0,
				mobile0));
//		c0.sendMsg(TestMessageGenerator.genGetUserListMessage(mobile0)); 			// 100W 数据，无法一次性获取
...
//		c0.sendMsg(TestMessageGenerator.genListActivitiesMessage(mobile0));			// 100W 数据，无法一次性获取
