 ...
 */
@Repository
public class WhereWebSocketServer {

    private static Logger log = Logger.getLogger(WhereWebSocketServer.class);
    
    @Config
    private int port = 10009;

    @Autowired
    private WhereWebSocketServerInitializer serverInitializer;
