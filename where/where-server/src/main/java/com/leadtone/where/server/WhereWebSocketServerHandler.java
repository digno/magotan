...
@Scope("prototype")
@Component
public class WhereWebSocketServerHandler extends SimpleChannelInboundHandler<Object> {
	private static final Logger logger = Logger
			.getLogger(WhereWebSocketServerHandler.class);
	...
	private void handleHttpRequest(ChannelHandlerContext ctx,
		...
		if ("/".equals(req.getUri())) {
			ByteBuf content = WhereWebSocketServerIndexPage
		...
		if (handshaker == null) {
			...
			rcManager.registerRiderChannel(ctx.channel());
		}
	}
